  ...
  <div class="card-css">
    <el-form ref="form" :model="companyInfo" label-width="80px">
      ...
      <el-form-item label="工作日">
        <el-slider v-model="workdays" range show-stops :min="1" :max="7" :marks="workDayMarks"></el-slider>
      </el-form-item>
      ...
      <el-form-item label="注册时间">
        <el-col :span="11">
          <el-date-picker
            type="date"
            placeholder="选择日期"
            v-model="companyInfo.registeredTime"
            style="width: 100%;"
          ></el-date-picker>
        </el-col>
      </el-form-item>
...
export default {
  ...
  created() {
    this.getIndustry();
    this.getUserInfo();
    this.companyInfo.basicHr = this.loginInfo.id;
  },
