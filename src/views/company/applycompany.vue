  ...
  <div>
    ...
    <div>
      <el-table :data="companyList" style="width: 100%">
        ...
        <el-table-column label="规模" prop="scale" width="250"></el-table-column>
        ...
        <el-table-column align="right">
          <template slot-scope="scope">
            ...
            <el-button
              ...
              @click="check(scope.row.id, 0)"
            ></el-button>
            <el-button type="danger" circle icon="el-icon-close" @click="check(scope.row.id, -1, scope.row.companyName)"></el-button>
          </template>
        </el-table-column>
      </el-table>
    </div>
